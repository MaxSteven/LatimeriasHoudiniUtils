...
def mtlxUsdImporter(selectednode, matname, importtextures):
        import hou
...
def splitToComponents(infile, removeprefix, generatematerials, importtextures, uvtransform, uvunwrap):        
    ...
    for name in name_attribs:
        ...
        if generatematerials==True:  
            ...
            selectednodepath = hou.Node.path(matlib_node)

            mtlxUsdImporter(selectednodepath, matname, importtextures)
